...
#define MPU9250_RESET() writeByte(MPU9250_ADDRESS, PWR_MGMT_1, 0x80) // Macro defined reset
...
#define ACCEL_CALIBRATION false
#define GYRO_CALIBRATION true
...
//Gyro Digital Lowpass Filter
enum DLPF_GYRO {
	DLPF_GYRO_250HZ = 0, // This value will set the clock to 8 kHz
	DLPF_GYRO_184HZ,
	DLPF_GYRO_92HZ,
	DLPF_GYRO_41HZ,
	DLPF_GYRO_20HZ,
	DLPF_GYRO_10HZ,
	DLPF_GYRO_5HZ,
	DLPF_GYRO_3600HZ // This value will set the clock to 8 kHz
};
...
class MPU9250
{
  ...
  public:
	...
	bool MPU9250SelfTest(); // Returns true if the self test is passed
